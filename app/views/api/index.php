<body class="w-[100vw] h-[100vh] overflow-hidden bg-[#F7F7FB] flex justify-center">
  ...
  <div class="lg:w-[1280px] md:w-[100vw] sm:w-[100vw] flex items-center justify-center" id="content-container">
    <div class="w-full h-[70%] flex flex-col items-center justify-center mt-[100px] backdrop-blur bg-white/50 rounded-md border-white/25 border-2 drop-shadow-xl">
  ...
  <script>
    ...
    async function getAllTokens(){
      objects = await(fetch('http://localhost/api/api_tokens'))
    }
  </script>
</body>