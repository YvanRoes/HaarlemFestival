      ...
      <div class="p-4 max-w-5xl grid gap-4">
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="h-16 bg-blue-50">
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam commodi ipsum sunt quis quia temporibus
              ipsam harum sequi doloremque.</p>
          </div>
        </div>
        ...
        <!-- Festival schedule -->
        <div
          class="w-maxcontent h-[175px] bg-blue-200 flex justify-center rounded-[15px] flex-row gap-16 leading-5 p-6 lg:pl-[75px] lg:pr-[75px] md:pl-[20px] sm:flex-row">
