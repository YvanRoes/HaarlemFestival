...
<title><? echo $location->get_name() ?></title>
...
<body class="overflow-x-hidden bg-[#F7F7FB] flex flex-col items-center h-fit w-screen">  
    ...
    <button type="submit" class="w-[100px] h-[40px] mt-[20px] bg-[#42BFDD] text-white text-[20px] font-bold rounded-[10px] cursor-pointer" onclick="back()">Back</button>
        ...
        <div class="grid grid-cols-2">
            <img class="w-[700px] h-[300px] mt-[50px]" src="<? echo $imagePaths[1] ?>">
            <img class="w-[600px] h-[300px] mt-[50px] justify-self-end" src="<? echo $imagePaths[2] ?>">
        </div>
        ...
        <img class="w-[800px] h-[300px] mt-[50px] justify-self-center mt-[50px]" src="<? echo $imagePaths[3] ?>">
    </div>
</body>
