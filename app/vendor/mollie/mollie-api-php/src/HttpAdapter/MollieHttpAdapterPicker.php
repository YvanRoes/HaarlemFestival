...
class MollieHttpAdapterPicker implements \Mollie\Api\HttpAdapter\MollieHttpAdapterPickerInterface
{
    ...
    public function pickHttpAdapter($httpClient)
    {
        ...
        if ($httpClient instanceof \_PhpScoper4c156ffd8c04\GuzzleHttp\ClientInterface) {
    ...
    {
        return \interface_exists('\\' . \_PhpScoper4c156ffd8c04\GuzzleHttp\ClientInterface::class);
    }
    /**
     * @return int|null
     */
    private function guzzleMajorVersionNumber()
    {
        ...
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            return (int) \_PhpScoper4c156ffd8c04\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        }
        // Before Guzzle 7
        if (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            return (int) \_PhpScoper4c156ffd8c04\GuzzleHttp\ClientInterface::VERSION[0];
        }
        return null;
    }
}
