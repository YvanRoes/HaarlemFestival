...
--
-- Host: mysql
-- Generation Time: Mar 26, 2023 at 03:23 PM
...
(2, 'Food event', 'Enjoy the wide variety of culinary delights that the city of Haarlem has to offer. Join us as we explore the city one bite at a time.', 'Food', '/img/festival-food-event.png'),
